...
### **A general overview of changes throughout Radiohead's nine studio albums** {data-commentary-width=400}
```{r}
...
### **A closer look: keys, modes, tempos and popularities within each album**  {data-commentary-width=400}
...
### **Does a classifier model agree that each Radiohead album has a distinct style?** {data-commentary-width=400}
...
### **To B-side or not to B-side: Kid A versus Amnesiac** {data-commentary-width=400}
...
### **A Moon Shaped Pool of tears: what makes Radiohead's last album sound so sad?** {data-commentary-width=400}
